...
import com.accumulation.app.ui.fragment.ViewPagerTabScrollViewFragment;
import com.accumulation.app.view.SlidingTabLayout;
import com.accumulation.lib.ui.scrollable.CacheFragmentStatePagerAdapter;
...
/**
 * This is an example of ViewPager + SlidingTab + ListView/ScrollView. This
 * example shows how to handle scroll events for several different fragments.
 * <p/>
 * SlidingTabLayout and SlidingTabStrip are from google/iosched:
 * https://github.com/google/iosched
 */
public class LiveSINAActivity extends BaseActivity implements
		...
		protected Fragment createItem(int position) {
			...
			default: {
				...
				if (0 <= mScrollY) {
					...
					args.putInt(ViewPagerTabScrollViewFragment.ARG_SCROLL_Y,
							mScrollY);
					f.setArguments(args);
				}
				break;
	...
	protected int getLayoutResId() {
		...
		return R.layout.activity_viewpagertab;
	}
}
