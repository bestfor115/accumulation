...
//    private int borderlength;
    ...
    private void initBmpPosition() {
        ...
        borderWidth = (int) (viewWidth - 2 * BORDERDISTANCE);
        borderHeight=ClipSquareView.BODER_CUT_HEIGHT;

        float screenScale = 1f;
        screenScale = (float) borderWidth / drawableWidth;
    ...
    private void checkMatrixBounds() {
        ...
        final float weightBorder = (viewWidth - borderWidth) / 2;
    ...
    public Bitmap clip(){
        ...
        draw(canvas);
        return Bitmap.createBitmap(bitmap, (getWidth() - borderWidth) / 2, (getHeight() - borderHeight) / 2, borderWidth, borderHeight);
    }
}
