...
import om.accumulation.lib.tool.statusbar.SystemBarTintManager;
...
public abstract class BaseActivity extends FragmentActivity {
	...
	protected void onResume() {
		...
		AccumulationAPP.getInstance().setCurrentActivity(this);
		IMManager.getManager().addStatistics(this, true);
	...
	protected void onPause() {
		...
		IMManager.getManager().addStatistics(this, false);
	...
	protected String getResponseMessage(JsonBase response) {
		String result = "«Î«Û ß∞‹";
		if (result != null) {
	...
	public boolean isLogined() {
		...
		return !CommonUtils.isEmpty(cookieManager.getCookie(URIConfig.DOMAIN));
	}
	
	public Dialog createLoadingDialog(){
		return UIUtils.createLoadingDialog(this, true);
	}
