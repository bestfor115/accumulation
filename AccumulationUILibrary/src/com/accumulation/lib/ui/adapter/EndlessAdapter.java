...
package com.accumulation.lib.ui.adapter;

import java.util.concurrent.atomic.AtomicBoolean;

import com.accumulation.lib.tool.net.imgcache.AsyncTask;
...
{
    /**
     * This method will be run in background thread for populate more data into the adapter
     * @return return true if there are more data to load
     * @throws Exception
     */
    abstract protected boolean cacheInBackground() throws Exception;

    /**
     * This is called in UI thread if cacheInBackground does not throw an exception
     */
