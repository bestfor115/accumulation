...
package com.accumulation.lib.ui.picker.date;
...
public class DatePickerDialog extends DialogFragment implements
	...
	public interface OnDateSetListener {
		 ...
		 */
		void onDateSet(DatePickerDialog view, Date date);

		void onHourClick(DatePickerDialog view, Date date);
	}
	...
	public static DatePickerDialog newInstance(OnDateSetListener callBack,
		...
		now.setTime(date);
		ret.initialize(callBack,now);
		return ret;
	}

	public void initialize(OnDateSetListener callBack,Calendar c) {
		mCallBack = callBack;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		okButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				tryVibrate();
				if (mCallBack != null) {
					mCallBack.onDateSet(DatePickerDialog.this,mCalendar.getTime());
				}
				dismiss();
			}
		});
		...
		mOtherInfo = (Button) view.findViewById(R.id.other_info);
		mOtherInfo.setText(TimeFormateTool.dateToString(mCalendar.getTime(), TimeFormateTool.FORMAT_TIME));
		mOtherInfo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				tryVibrate();
				if (mCallBack != null) {
					mCallBack.onHourClick(DatePickerDialog.this,mCalendar.getTime());
				}
				dismiss();
			}
		});
