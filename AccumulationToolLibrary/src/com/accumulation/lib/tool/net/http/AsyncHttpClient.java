...
package com.accumulation.lib.tool.net.http;
...
public class AsyncHttpClient {
	...
	public static String getUrlWithQueryString(String url, RequestParams params) {
		...
		Logger.splitAndLog("ServiceHelper", "url " + url);
	...
	public static String parseResponse(HttpResponse response){
		return parseResponse(response, "UTF-8");
	}
	
	public static String parseResponse(HttpResponse response, String defaultEncoding) {
	...
	public String syncPost(String url,  RequestParams params,Header[] headers)
			throws ClientProtocolException, IOException {
		HttpEntityEnclosingRequestBase request = addEntityToRequestBase(new HttpPost(url), paramsToEntity(params));
		request.setHeaders(headers);
		return parseResponse(syncExec(request));
	}
	...
	public HttpResponse syncExec(HttpUriRequest request)
			throws ClientProtocolException, IOException {
