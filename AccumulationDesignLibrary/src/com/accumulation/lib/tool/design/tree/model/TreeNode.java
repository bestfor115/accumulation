package com.accumulation.lib.tool.design.tree.model;
...
import com.accumulation.lib.tool.design.tree.AndroidTreeView;
import com.accumulation.lib.tool.design.tree.TreeNodeWrapperView;
...
public class TreeNode {
    ...
    public void setSelected(boolean selected) {
        mSelected = selected;
        if(mViewHolder!=null){
        	mViewHolder.toggleSelected(selected);
        }
    }
