...
public final class RSAUtils
{
     ...
     *
     * */
    public static void exampleEncrypt(Context context){
        // 从字符串中得到公钥
        // PublicKey publicKey = RSAUtils.loadPublicKey(PUCLIC_KEY);
        // 从文件中得到公钥
        try{
            String source = "this is a test for encode";
     ...
     *
     * */
    public static void exampleDecrypt(Context context){
        // 从字符串中得到公钥
        // PublicKey publicKey = RSAUtils.loadPublicKey(PUCLIC_KEY);
        // 从文件中得到公钥
        try{
            String encryptContent = "this is a test for encode";
            // 从字符串中得到私钥
