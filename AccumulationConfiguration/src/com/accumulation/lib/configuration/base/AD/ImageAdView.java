...
import com.accumulation.lib.configuration.base.SwitchAnimations;
import com.accumulation.lib.configuration.base.AD.ImageAd.ImageEntry;
...
public class ImageAdView extends ImageSwitcher implements IConfigView {
	...
	// super.draw(canvas);
	//
	// canvas.drawText("广告位", getWidth()/2, getHeight()/2, mPaint);
	//
	// }
...
//			imageView.setImageURI(uri);//直接用可能导致oom
...
//	}
	...
	public ImageAdView(Context ctx, com.accumulation.lib.configuration.core.View data) {
		this(ctx);
		this.mView = data;
