...
import com.accumulation.lib.configuration.base.BasicPagerAdapter;
...
public class ViewPager extends android.support.v4.view.ViewPager implements IConfigView{
	...
	public ViewPager(Context context, View data) {
		super(context);
		this.mData = data;
